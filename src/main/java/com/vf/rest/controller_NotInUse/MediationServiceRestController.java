...
public class MediationServiceRestController {
    ...
    public int asm_checkJobAlreadyRunning(String jobId) throws Exception {
    	...
    	String url = "https://noi-topology-file-observer.verizon-noi.svc/1.0/rest-observer/jobs/"+jobId;
    ...
    public int asm_startBulkJob(String jobId) throws Exception {
    	...
    	RestTemplate restTemplate = new RestTemplate();
    	String url = "https://noi-topology-file-observer.verizon-noi.svc/1.0/rest-observer/jobs/bulk_replace";
    	HttpHeaders headers = new HttpHeaders();
    	headers.setContentType(MediaType.APPLICATION_JSON);
    	headers.set("X-TenantID", "cfd95b7e-3bc7-4006-a4a8-a73a79c71255");
    	headers.set("Content-Type", "application/json");
    ...
    public int asm_syncBulkJob(String jobId) throws Exception {
    	...
    	RestTemplate restTemplate = new RestTemplate();
    	String url = "https://noi-topology-file-observer.verizon-noi.svc/1.0/rest-observer/jobs/"+jobId+"/synchronize";
    	HttpHeaders headers = new HttpHeaders();
    	headers.setContentType(MediaType.APPLICATION_JSON);
    	headers.set("X-TenantID", "cfd95b7e-3bc7-4006-a4a8-a73a79c71255");
    	headers.set("Content-Type", "application/json");
    ...
    public void asm_createResource(List<ASMResource> resources,String jobId) throws Exception {
    	...
    	String url = "https://noi-topology-file-observer.verizon-noi.svc/1.0/rest-observer/rest/resources";
    	HttpHeaders headers = new HttpHeaders();
    	headers.setContentType(MediaType.APPLICATION_JSON);
    	headers.set("X-TenantID", "cfd95b7e-3bc7-4006-a4a8-a73a79c71255");
    	headers.set("Content-Type", "application/json");
    ...
    public void asm_createEdge(List<ASMEdge> edges,String jobId) throws Exception {
    	...
    	String url = "https://noi-topology-file-observer.verizon-noi.svc/1.0/rest-observer/rest/references";
    	HttpHeaders headers = new HttpHeaders();
    	headers.setContentType(MediaType.APPLICATION_JSON);
    	headers.set("X-TenantID", "cfd95b7e-3bc7-4006-a4a8-a73a79c71255");
    	headers.set("Content-Type", "application/json");
